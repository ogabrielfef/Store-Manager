...
const { findAll, findById, createProduct, findAllSales, findSalesById } = require('../../../src/services/products.service');
const productModel = require('../../../src/models/products.model');
const { products, invalidValue, newProduct, name, vendas } = require('./mocks/products.service.mock');
